    ...
    MouseTouchRangeSlider.prototype = {
        ...
        init: function () {
            var container_html = '<span class="rs rs-' + this.plugin_count + '"></span>',
                rangeSlider_html = '<span class="rs-track" tabindex="-1"></span>' + '<span class="rs-track rs-trackBackground" tabindex="-1"></span>' +// FYI - having the tabindex made the span focusable
        ...
        pointerMove: function (e) {
            ...
            currentValue1 =  Math.round(currentPosition / this.coords.oneStepPixels);
            ...
            if((currentValue1 * this.coords.oneStepPercentage + 10) >97 ){
                sliderPosition1 = 97 + '%';
            }else if((currentValue1 * this.coords.oneStepPercentage + 10) < 10){
                sliderPosition1 = 10 + '%';
            }else{
                sliderPosition1 = currentValue1 * this.coords.oneStepPercentage + 10+ "%";
            }
          
            
            this.$cache.source_input.prop("value", comma(currentValue));
            this.$cache.slider[0].style.left = sliderPosition;
            this.$cache.track[0].style.width = sliderPosition1;
        ...
        pointerUp: function (e) {
            ...
            var dragNumber;
            dragNumber = uncomma(this.$cache.source_input.prop("value"));
            this.coords.absolutePixelPointer = dragNumber * this.coords.oneStepPixels;
            this.result.value = dragNumber;
        ...
        shiftOneStep: function (right) {
            ...
            clickNumber = uncomma(this.$cache.source_input.prop("value"));
            var currentValue = parseInt(clickNumber, 10);
            // console.log("떠블클릭" + currentValue);
            console.log("currentValue > " + currentValue );
            console.log("this.options.min  " + this.options.min);
        ...
        update: function (value) {
            ...
            this.$cache.track[0].style.width = value * this.coords.oneStepPercentage + 10 + "%";
